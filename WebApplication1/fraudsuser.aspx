<%@ Page Title="" Language="C#" MasterPageFile="~/User.Master" AutoEventWireup="true" CodeBehind="fraudsuser.aspx.cs" Inherits="WebApplication1.fraudsuser" %>
...
<td runat="server" />
        ...
        <ItemTemplate>
            <td runat="server" style="padding-left:70px;position: relative;
padding-top:12px;
