...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
  ...
  top: 30%;
  left: 50%;
  transform: translate(-50%, -50%); background-color:rgba(0,0,0,0.8); padding:20px " ><h2 style="color:white; font-family:'Bodoni MT'" >You &nbsp are  &nbsp  now &nbsp  at  &nbsp the  &nbsp  center  &nbsp of   &nbsp security.</h2>
...
<h2 style="color:white; font-family:'Bodoni MT'">  Because we care, we're security aware. If something  sounds too good to be true… there’s probably a scammer behind it. </h2>
