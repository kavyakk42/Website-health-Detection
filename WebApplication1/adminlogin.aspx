...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
     <div  style=" height:100%;padding-bottom:200px ; background-image:url('images/admin.jpg'); background-size:cover;width:2000px" >
    <br /> 
 <br />
   ...
   background-image:url('images/user.jpg') ; background-size:contain; background-repeat:no-repeat;
    ...
    width: 460px;  padding:10px ; font-size:larger; font-stretch:extra-expanded" OnClick="adminbut_Click1"   />
                    ...
                    <asp:LoginStatus ID="LoginStatus3" runat="server"  ForeColor="White" Visible="false"/>
