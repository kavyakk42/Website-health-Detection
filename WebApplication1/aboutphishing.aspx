<%@ Page Title="" Language="C#" MasterPageFile="~/User.Master" AutoEventWireup="true" CodeBehind="aboutphishing.aspx.cs" Inherits="WebApplication1.aboutphishing" %>
         ...
         <div class="wrapper">
            ...
            <nav id="sidebar" style="background-color:#273746; height:initial" > <br />
                ...
                <ul class="list-unstyled components">
                    ...
                    <li>
                        <a href="phishingvisual"style="color:white "> View Visualizations</a>
                    </li>&nbsp;
                    <li>
