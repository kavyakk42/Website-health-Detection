...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div style="background-image:url('images/ForWebsite-1192x423.png'); background-repeat: no-repeat; height: 100%; background-size: cover; font-family:'Lucida Sans', 'Lucida Sans Regular', 'Lucida Grande', 'Lucida Sans Unicode', Geneva, Verdana, sans-serif;width:1500px" >
            <br />
...
<div class="col-6">
    <div class="input-group">
    <asp:TextBox ID="URL_sensitiveWord2" runat="server" class="form-control" placeholder="Enter number of URL Sensitive Words" ></asp:TextBox>
