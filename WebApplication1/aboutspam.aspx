<%@ Page Title="" Language="C#" MasterPageFile="~/User.Master" AutoEventWireup="true" CodeBehind="aboutspam.aspx.cs" Inherits="WebApplication1.aboutspam" %>
         ...
         <div class="wrapper">
            ...
            <nav id="sidebar" style="background-color:#273746; height:initial" > <br />
                ...
                <ul class="list-unstyled components">
                    ...
                    <li>
                        <a href="spamvisual"style="color:white "> View Visualizations</a>
                    </li>&nbsp;
                    <li>
