...
{
    public partial class checkdefacement : System.Web.UI.Page
    {
        ...
        CacmsRLang lg = new CacmsRLang();
        protected void Page_Load(object sender, EventArgs e)
        {

            int s = Convert.ToInt32(Request.QueryString["q"]);
            f.Fill(w.Defacement);
            row = w.Defacement.FindById(s);
            int k;
            ...
            lg.WriteScript("dataset=read.csv('Phishing.csv') " +
